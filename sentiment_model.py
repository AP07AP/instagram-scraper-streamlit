...
rules_dict = {
    "phonetic_mappings": {
        "ph": "f", "wh": "v", "zh": "z", "dh": "d", "bh": "b", "gh": "g",
        "kh": "k", "th": "t", "ch": "c", "yy": "y", "zz": "z", "nn": "n",
        "rr": "r", "tt": "t", "ll": "l", "mm": "m", "kk": "k", "pp": "p",
        "dd": "d", "gg": "g", "bb": "b", "ss": "s", "cc": "c"
    },
    "vowel_mappings": {
        "aa": "a", "aaa": "a", "aaaa": "a",
        "ee": "e", "eee": "e", "ii": "i", "iii": "i",
        "oo": "o", "ooo": "o", "uu": "u", "uuu": "u",
        "ai": "ai", "ay": "ai", "au": "au", "ow": "au",
        "ei": "e", "ey": "e"
    },
    "standard_spellings": {},
    "telugu_stop_words": ["oo", "aa", "ee", "oh", "ayya", "amma", "ante", "anna", "mari", "sare", "okay", "ok", "hmm", "haa", "kaadu"],
    ...
    "booster_words": ["chaala", "super", "goppa", "bhale", "bavundi", "bavunna", "best", "excellent", "great", "really"],
    "translit_variants": {
        "nennu": "nenu", "miru": "meeru", "vunnadi": "unnadi", "chusanu": "chusanu",
        "chesanu": "chesanu", "bagundi": "bagundi", "chettadi": "chettadi"
    }
}

# ------------------------
# Enhanced Telugu Preprocessor
# ------------------------
class EnhancedTeluguPreprocessor:
    def __init__(self, rules_dict=rules_dict):
        self.rules = rules_dict
    ...
    def preprocess(self, text):
        ...
        text = self._apply_rules(text, self.boosters)
        text = self.punctuation_pattern.sub("", text)
        text = emoji.replace_emoji(text, replace='')  # simple emoji removal
        return text
